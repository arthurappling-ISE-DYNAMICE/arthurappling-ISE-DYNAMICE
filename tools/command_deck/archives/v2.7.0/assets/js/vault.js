...
(function () {
    ...
    const CLASSIFICATIONS = Object.freeze([
        Object.freeze({ code: 'SOP', label: 'Standard Operating Procedure', test: /workflows\/|sop|protocol/i }),
        Object.freeze({ code: 'AGENT', label: 'Agent Specification', test: /agents\/|agent|_framework/i }),
        Object.freeze({ code: 'CONTRACT', label: 'Contract Intelligence', test: /contract|bid_|rfp/i }),
        Object.freeze({ code: 'EVIDENCE', label: 'Evidence Record', test: /evidence|receipt|photo|scan/i }),
        Object.freeze({ code: 'INTEL', label: 'Strategic Intelligence', test: /intel|research|market/i }),
        Object.freeze({ code: 'TOOL', label: 'Tooling / Engine', test: /tools\/|engine|\.py$|\.js$/i })
    ]);
    ...
    const vault = {
        ...
        restore() {
            try {
                ...
                const self = this;
                this.documents = new Map(data.docs.map(function (d) { return [d.id, d]; }));
