...
(function () {
    ...
    function seed() {
        ...
        // PROPOSALS (v2.9.6) — links.clients set so the relations engine binds them.
        s.proposals.create({ id: 'PRO-2026-A', clientId: 'sample_consulting_a',
            title: 'AI Consulting Engagement — Elite 10 Sovereign Deck', amount: 5000, status: 'ACCEPTED',
            createdDate: '2026-05-18', proposalDate: '2026-05-20', expectedCloseDate: '2026-06-01',
            notes: 'NEPQ-qualified; accepted, advanced to contract.',
        ...
        s.proposals.create({ id: 'PRO-2026-B', clientId: 'sample_ecom_b',
            title: 'Shopify Platform Build — Storefront + Payment Rails', amount: 2500, status: 'DRAFT',
            createdDate: '2026-06-05', proposalDate: '', expectedCloseDate: '2026-07-15',
            notes: 'Awaiting catalog definition before send.',
            links: { clients: ['sample_ecom_b'], projects: ['shopify_platform'] } }, quiet);

        // CONTRACTS (v2.9.6) — clientId + proposalId fields, links.clients for the engine.
        s.contracts.create({ id: 'CON-2026-A', clientId: 'sample_consulting_a', proposalId: 'PRO-2026-A',
            title: 'Consulting Master Services Agreement', status: 'SIGNED', value: 5000,
            effectiveDate: '2026-06-02', expirationDate: '2026-12-02',
            links: { clients: ['sample_consulting_a'] } }, quiet);
