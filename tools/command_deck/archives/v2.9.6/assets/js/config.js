...
(function () {
    ...
    SYSOS.CONFIG = Object.freeze({
        ...
        STORE: Object.freeze({
            ...
            SEED_VERSION: 4,        // v2.9.6: proposals + contracts domains added — bump forces reseed
            ACTIVITY_CAP: 50
        }),
        ...
        COMMERCIAL: Object.freeze({
            ...
            PROPOSAL_STATUSES: Object.freeze(['DRAFT', 'SENT', 'VIEWED', 'NEGOTIATING', 'ACCEPTED', 'DECLINED', 'EXPIRED']),
            ...
            PROPOSAL_WEIGHTS: Object.freeze({
                DRAFT: 0.1, SENT: 0.25, VIEWED: 0.4, NEGOTIATING: 0.6, ACCEPTED: 0.9, DECLINED: 0, EXPIRED: 0
            }),
            // Health scoring: points per signal, thresholds for GREEN/YELLOW/RED
            HEALTH: Object.freeze({
                ACTIVITY_STALE_DAYS: 30,   // no activity beyond this drops a point
                GREEN_MIN: 70,
                YELLOW_MIN: 40
            })
        }),
