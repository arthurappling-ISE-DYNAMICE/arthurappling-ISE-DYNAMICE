    ...
    SYSOS.registriesInit = function () {
        panelRef = SYSOS.router.register({
            ...
            render: function (panel) {
                ...
                panel.querySelector('#registry-search').addEventListener('input', SYSOS.utils.debounce(renderTable, 150));
                panel.querySelector('#registry-status-filter').addEventListener('change', renderTable);
                refresh();
            }
        });
