...
(function () {
    ...
    SYSOS.commercialUI = {
        ...
        // v3.7: open the existing edit form for any commercial record type.
        edit(recordMode, id) { mode = recordMode; editId = id; renderForm(); },
        editClient(id) { this.edit('client', id); }
    };
})();
