...
**TRAP GAME WARNINGS:** Identify exactly 2 trap games per week — teams favored by public sentiment but carrying hidden risk (injury, travel, divisional trap). Flag in red with reason.
...
- **Apr 24:** Rounds 2–3 — **SBDC MEETING DAY** (see priority rule below)
- **Apr 25:** Rounds 4–7 — depth/value picks; lower impact on O/U lines

**Draft Analysis Protocol:**
- Flag every team that drafts: CB1, EDGE, DT, LB in Round 1–2
- Defensive reinforcement = tighten Over totals for that team's first 4 games
...
### PRIORITY CONFLICT RULE — APR 24, 2026
**SBDC Meeting with Alec Ihrig takes absolute priority.**
- During the 30-minute SBDC window: all draft monitoring suspended
- No alerts, no summaries, no interruptions
- Post-meeting trigger: auto-summarize Round 1 draft picks and their O/U impact for the XERO XERO Dashboard

### POST-SBDC AUTO-SUMMARY FORMAT
After the April 24 meeting closes, produce this block for the dashboard:

| Team | Pick | Position | O/U Impact | Confidence Shift |
|------|------|----------|-----------|-----------------|
| [Team] | [Rd/Pick#] | [Pos] | Tighten Over / Tighten Under | +/-X% |

Append to: `tools/betting_engine/public/dashboard.html` → Draft Intelligence panel
